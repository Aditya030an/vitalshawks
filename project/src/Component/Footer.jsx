      ...
      <div className="max-w-7xl mx-auto px-6 py-14 grid grid-cols-1 md:grid-cols-3 gap-10 text-gray-700">
        ...
        <div>
          <div className="flex items-center space-x-3">
            <img src={logo} alt="Vital Hawks Logo" className="h-10 w-10 rounded-lg shadow-md" />
            <h2 className="text-2xl font-bold text-gray-900 tracking-tight">
              Vital Hawks
            </h2>
          </div>
          <p className="mt-5 text-sm leading-relaxed text-gray-600 max-w-sm">
            At Vital Hawks, we help sales teams focus on closing deals by removing
            time-consuming tasks like researching and verifying leads — so they can
            concentrate on what truly drives revenue.
          </p>
        </div>
